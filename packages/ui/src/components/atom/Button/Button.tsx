...
export const buttonVariants = cva(
  ...
  [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive px-3 rounded-sm`,
  {
    variants: {
      variant: {
        default:
          "bg-primary-300 text-primary-900 hover:bg-blue-300 disabled:bg-point-blue-disable",
        destructive:
