...
const Input = ({
  ...
  const InputTextStyle = `${invalid === true ? "enabled:placeholder:text-red-600 text-red-600" : "placeholder:text-gray-300 focus:placeholder:text-black text-black"} outline-none text-xs placeholder:text-xs h-full w-full p-2 disabled:text-gray-300 disabled:cursor-not-allowed`;
