        ...
        <div>
          <div className="flex w-full items-start gap-2">
            ...
            <div className="w-2/5 break-all whitespace-pre-wrap text-right">
              {facility.code && (
                <span className="inline-block text-[10px] leading-4 bg-primary-400 text-primary-900 px-2 py-1 rounded break-all">
                  {facility.code}
                </span>
              )}
            </div>
          ...
          {facility.description && (
            <div className="text-xs text-secondary-300 mt-1 break-words">{facility.description}</div>
          )}
